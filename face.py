...
#separator.pack(fill=X, padx=5, pady=5)
		...
		Label(info,text="Student Id:",font=("times new roman", 17),fg="black").grid(row=0,column=4,padx=0)
...
#One Button for all things
		...
		recg=LabelFrame(optFrame, text="Recognize",fg="black",padx=171,pady=5,font=("times new roman", 18))
...
##To Get Out Of The Program
		Kill=LabelFrame(optFrame, text="Close and Excel file Generation",fg="black",padx=292, pady=10,font=("times new roman", 18))
