...
def startDetectors(event=None):
	...
	logfile.write(str(noone)+" Accpted\n"+str(nozero)+" Rejected\n"+"total guests detected "+str(noone+nozero))
	logfile.close()
	print(filename)
	os.system('start '+''+filename+'')
...
#separator.pack(fill=X, padx=5, pady=5)
		...
		Label(info,text="Event name:",font=("times new roman", 17),fg="black").grid(row=0,column=2,padx=0)
		classEntry = Entry(info, textvariable=className,font=("times new roman",17))
		classEntry.grid(row=0,column=3,padx=10,ipady=2)
		Label(info,text="PIN:",font=("times new roman", 17),fg="black").grid(row=0,column=4,padx=0)
